# Define a class called Lunch.Its __init__() method 
# should have two arguments:self and menu.
...
# To check if it works define: Paul=Lunch("menu 1")
# and call Paul.menu_price()
